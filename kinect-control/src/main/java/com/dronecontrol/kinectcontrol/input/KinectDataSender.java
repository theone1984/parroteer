...
import com.dronecontrol.kinectcontrol.input.data.DroneData;
...
public class KinectDataSender implements NavDataListener
{
  ...
  @Inject
  public KinectDataSender(SocketClient socketClient, JsonFactory jsonFactory, ObjectMapper objectMapper)
  {
